...
// TestMain bootstraps the envtest control plane.
func TestMain(m *testing.M) {
	utilruntime.Must(clientgoscheme.AddToScheme(scheme))
	utilruntime.Must(securityv1alpha1.AddToScheme(scheme))

	// CRDs live four directories up at <repo>/crds/bases relative to
	// this test file: sdk/pkg/runtime/ttl -> ../../../.. -> repo root.
...
// ctxT returns a fresh background context.
