...
// Package serverv1 implements ugallu-resolver's gRPC server (design
// 03 R6 + R7). It maintains client-go informer caches for Pod, Node,
...
//   - ResolveBySAUsername   — intelligent parsing per design 03 R4
//
...
//
// Cache invalidation uses a tombstone GC (60s grace, design 03):
